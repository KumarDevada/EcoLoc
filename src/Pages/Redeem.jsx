  ...
  return (
    <div>
        ...
        <div style={ {display:'flex' ,width: '90vw', height:'540px', backgroundColor:'lightgrey', borderRadius:'30px' , marginLeft:'60px', paddingLeft:'20px'}}>
            <div className='hover:opacity-50 cursor-pointer' style={{width:'350px', backgroundColor:'whitesmoke', borderRadius:'30px', overflow:'hidden', boxShadow:3, border: '1px solid grey', margin:'30px'}}>
                ...
                <div style={{margin:'30px', marginBottom:'0px', display:'flex', flexDirection:'column', alignItems:'center'}}>
                    ...
                    <h2 className='text-5xl text-slate-500 font-bold font-sans'>199 <i style={{color:'orange'}} class="fa-brands fa-bitcoin"></i></h2>
                </div>
            </div>
            ...
            <div className='hover:opacity-50 cursor-pointer' style={{width:'350px', backgroundColor:'whitesmoke', borderRadius:'30px', overflow:'hidden', boxShadow:3, border: '1px solid grey', margin:'30px'}}>
                ...
                <div style={{margin:'30px', display:'flex', flexDirection:'column', alignItems:'center'}}>
                    ...
                    <h2 className='text-5xl text-slate-500 font-bold font-sans'>299 <i style={{color:'orange'}} class="fa-brands fa-bitcoin"></i></h2>
                </div>
            </div>
            ...
            <div className='hover:opacity-50 cursor-pointer' style={{width:'350px', backgroundColor:'whitesmoke', borderRadius:'30px', overflow:'hidden', boxShadow:3, border: '1px solid grey', margin:'30px'}}>
                ...
                <div style={{margin:'30px', display:'flex', flexDirection:'column', alignItems:'center'}}>
                    ...
                    <h2 className='text-5xl text-slate-500 font-bold font-sans'>499 <i style={{color:'orange'}} class="fa-brands fa-bitcoin"></i></h2>
                </div>
            </div>
        </div>
    </div>
