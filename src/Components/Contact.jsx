  ...
  return (
    <div id="contact">
      <div className="flex flex-col  justify-center items-center mt-[20vh]">
        ...
        <div className="w-fit h-fit bg-green-300 shadow-xl rounded-3xl  p-[5vh] md:ml-5 mb-10 z-10 searchtext ">
          <h1 className="md:text-[5vh] text-[8vh] font-mono  font-bold">
            Contact our Team
          </h1>
          <p className=" text-slate-600 text-lg font-montserrat font-medium">
