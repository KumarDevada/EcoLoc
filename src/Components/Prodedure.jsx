    ...
    <Wrapper>
      <div className=" flex flex-col  justify-center items-center mt-[20vh] relative">
        ...
        <div className="flex flex-col  gap-5 md:flex-row  w-full justify-between items-center  relative ">
          ...
          <div className="z-10 shadow-xl bg-green-300 w-full md:w-[20vw] h-fit md:p-8 p-4 flex justify-center items-center rounded-3xl font-montserrat font-bold">
      ...
      <p className="mt-[10vh] text-xl text-slate-600 md:w-[60vw] text-center font-montserrat font-semibold">We're the link between e-waste recycling companies and eco-conscious consumers. Our platform connects clients with trusted recycling partners, streamlining the recycling process and offering rewards for sustainable choices.</p>
      </div>
    </Wrapper>
  );
};
